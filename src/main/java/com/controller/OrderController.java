...
public class OrderController {
    ...
    public static void search (Scanner reader){
        OrderDealer orderDealer;
        String id = Utilities.askInfo(reader,"Enter an id Order");
        orderDealer = PersistenceCEOCR.find(id,4);
        if(orderDealer == null){
            System.out.println("this order no exists");
        }
        else System.out.println(orderDealer);
    }
